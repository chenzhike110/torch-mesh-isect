...
at::Tensor bvh_forward(at::Tensor triangles, at::Tensor weights, int max_collisions = 16) {
    ...
    bvh_cuda_forward(triangles, weights,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &bvh_forward, "BVH collision forward (CUDA)",
        py::arg("triangles"), py::arg("weights"), py::arg("max_collisions") = 16);
}
